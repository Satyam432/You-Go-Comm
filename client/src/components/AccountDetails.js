...
const AccountDetails = () => {
			...
			try {
				...
				if (user.data.success) {
					if (user.data.user.name !== null) {
						formFields.firstName = user.data.user.name.split(' ')[0];
					...
					dispatch(getUser(user.data.user.user_id, user.data.user.image_url));
				} else {
	...
	const validate = () => {
		...
		if (formFields.firstName.length < 2 || formFields.firstName.length > 30) {
		...
		const age =
			Math.abs(today.getTime() - date.getTime()) / (1000 * 3600 * 24 * 365.25);
	...
	const submitHandler = (e) => {
		...
		if (!error) {
			...
			const postData = {
				...
				contact: formFields.mobile !== '' ? formFields.mobile : undefined,
								...
								<Row>
									<Col xs='12' md={{ size: 4, offset: 2 }}>
										<TextField
											...
											helperText={fieldErrors.firstNameError}
									...
									<Col xs='12' md='4'>
										<TextField
											...
											helperText={fieldErrors.lastNameError}
								...
								<Row>
									<Col xs='12' md={{ size: 8, offset: 2 }}>
										<TextField
											...
											helperText={fieldErrors.birthDateError}
											error={fieldErrors.birthDateError !== ''}
											type='date'
											onChange={changeHandler}
											variant='outlined'
											InputProps={{
								...
								<Row>
									...
									<Col xs='12' md='4'>
										<TextField
											...
											helperText={fieldErrors.collegeError}
											error={fieldErrors.collegeError !== ''}
											variant='outlined'
											InputProps={{
												classes: {
													notchedOutline: classes.notchedOutline
								...
								<Row>
									<Col xs='12' md={{ size: 8, offset: 2 }}>
										<TextField
											...
											helperText={fieldErrors.linkedInError}
											type='url'
											error={fieldErrors.linkedInError !== ''}
											variant='outlined'
											InputProps={{
												classes: {
													notchedOutline: classes.notchedOutline
